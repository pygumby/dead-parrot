...
It implements an AI assistant that answers questions on ECB Banking Supervision matters.
...
- [constants.py](src/ecb_bs_ai_assistant/constants.py) defines names and other constants.
- [ai_assistant.py](src/ecb_bs_ai_assistant/ai_assistant.py) defines the AI assistant using dead-parrot.
- [temporal_workflow.py](src/ecb_bs_ai_assistant/temporal_workflow.py) defines a Temporal workflow that calls the AI assistant.
- [temporal_worker.py](src/ecb_bs_ai_assistant/temporal_worker.py) defines and runs a Temporal worker for the Temporal workflow.
- [rest_server.py](src/ecb_bs_ai_assistant/rest_server.py) defines and runs a REST server that exposes the Temporal workflow.
- [mcp_server.py](src/ecb_bs_ai_assistant/rest_server.py) defines and runs an MCP server that exposes the Temporal workflow.
...
2. Optionally, query, evaluate and optimize the AI assistant:
    ```
    uv run --directory demos/ecb_bs_ai_assistant python -m ecb_bs_ai_assistant.ai_assistant
    ```
...
- [constants.py](src/ecb_bs_ai_assistant/constants.py)
  Update the constants.
- [ai_assistant.py](src/ecb_bs_ai_assistant/ai_assistant.py)
  Customize the AI assistant's definition.
- [temporal_workflow.py](src/ecb_bs_ai_assistant/temporal_workflow.py)
  Change the Temporal worklow's name and update references accordingly in:
  - [temporal_worker.py](src/ecb_bs_ai_assistant/temporal_worker.py)
  - [rest_server.py](src/ecb_bs_ai_assistant/rest_server.py)
  - [mcp_server.py](src/ecb_bs_ai_assistant/mcp_server.py)
