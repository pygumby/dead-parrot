# Task: Generate an evaluation dataset for a RAG system on ECB BS – Category "Out-of-scope refusals" (15 question-answer pairs)
...
- **Expected questions**:
  Inquiries about non-BS matters, e.g., monetary policy, general knowledge, current events, IT support, personal advice unrelated to BS.
- **Expected answer**:
  A brief, formal refusal explaining that the agent only handles BS matters.
