# Task: Generate an evaluation dataset for a RAG system on ECB BS – Category "Multi-passage ECB Supervisory Manual" (15 question-answer pairs)
...
## Task
Generate exactly 15 question-answer pairs that fall into the category "Multi-passage ECB Supervisory Manual":
- **Expected questions**:
  BS-related inquiries from ECB staff members whose correct answer requires combining information from two or more distinct passages within the attached document, e.g., paragraphs on different pages, or different articles/sections.
