...
It implements an expert agent that answers questions on European Central Bank (ECB) Banking Supervision matters, grounded in public ECB documents.
...
- [ecb_supman.pdf](documents/ecb_supman.pdf): ECB Supervisory Manual
