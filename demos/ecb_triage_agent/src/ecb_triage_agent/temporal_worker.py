...
from .constants import PACKAGE_NAME, TRIAGE_AGENT_NAME
from .temporal_workflow import EcbTriageAgentWorkflow, temporal_lm_program
...
async def run_temporal_worker() -> None:
    ...
    temporal_worker: Worker = Worker(
        ...
        workflows=[EcbTriageAgentWorkflow],
        plugins=[DSPyPlugin(temporal_lm_program)],
