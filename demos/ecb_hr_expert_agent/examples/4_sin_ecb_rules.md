# Task: Generate an evaluation dataset for a RAG system on ECB HR – Category "Single-passage ECB Staff Rules" (30 question-answer pairs)
...
## Task
Generate exactly 30 question-answer pairs that fall into the category "Single-passage ECB Staff Rules":
- **Expected questions**:
