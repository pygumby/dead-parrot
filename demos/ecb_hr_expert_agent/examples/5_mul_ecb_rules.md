# Task: Generate an evaluation dataset for a RAG system on ECB HR – Category "Multi-passage ECB Staff Rules" (15 question-answer pairs)
...
## Task
Generate exactly 15 question-answer pairs that fall into the category "Multi-passage ECB Staff Rules":
- **Expected questions**:
