...
## 4. Delegating via triage

|     | Agent                                                                                                                                                  | Metric    | Judge LM | Teacher LM | Task LM    | Score (devset) | Score (testset) |
| :-- | :----------------------------------------------------------------------------------------------------------------------------------------------------- | :-------- | :------- | :--------- | :--------- | :------------- | :-------------- |
| 4.1 | [ecb_hr_expert_agent, reduced dataset, optimized, gpt-5-mini](./4_delegating_via_triage/4_1_ecb_hr_expert_agent_reduced_dataset_optimized_gpt_5_mini/) | composite | gpt-5    | gpt-5      | gpt-5-mini | 86.44          | 81.52           |
| 4.2 | [ecb_bs_expert_agent, reduced dataset, optimized, gpt-5-mini](./4_delegating_via_triage/4_2_ecb_bs_expert_agent_reduced_dataset_optimized_gpt_5_mini/) | composite | gpt-5    | gpt-5      | gpt-5-mini | 79.08          | 77.07           |
